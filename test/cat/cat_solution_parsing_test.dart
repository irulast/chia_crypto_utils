...
void main() {
  test('should parse tibet swap cat solution correctly', () {
    ...
    expect(
      ...
      Bytes.fromHex('0xee555b0273f7cae7bf7196a4087eb8b484000d8368cc11ce04a6fde8848b3e7a'),
    );
    ...
    expect(
      ...
      CoinPrototype(
        parentCoinInfo:
            Bytes.fromHex('0x1535144d3e1337a60e249eaa88cac595618895cabd1b6c32a4c6a62b895a8415'),
    ...
    expect(
      ...
      CoinPrototype(
        parentCoinInfo:
            Bytes.fromHex('0x5eea91688d21b0bf943426f989601eb3d1b29f342f5290cd960dcf697a14eb90'),
        puzzlehash: Puzzlehash.fromHex(
