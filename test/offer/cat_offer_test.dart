...
void main() {
  ...
  test('should parse CAT2 offer files', () {
    ...
    expect(offerPoolUsdsOffer.requestedAmounts.cat[usdsAssetId],
        equals(0.42 * mojosPerCat));

    expect(offerPoolUsdsOffer.offeredAmounts.standard,
    ...
    expect(offerPoolSpacebucksOffer.requestedAmounts.standard,
