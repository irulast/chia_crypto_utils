...
void main() {
  ...
  test('should parse CAT1 offer files', () {
    ...
    expect(offerBinOffer.requestedAmounts.cat[usdsAssetId],
        equals(15 * mojosPerCat));

    expect(offerBinOffer.offeredAmounts.standard,
    ...
    expect(offerPoolOffer.requestedAmounts.standard,
    ...
    expect(offerPoolOffer.offeredAmounts.cat[sporkAssetId],
