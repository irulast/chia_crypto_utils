...
void main() {
  ...
  test('should correctly serialize and deserialize XCH to BTC offer file', () {
    ...
    expect(deserializedOfferFile.initializationCoinId, equals(initializationCoinId));
  ...
  test('should correctly serialize and deserialize XCH to BTC offer accept file', () {
    ...
    expect(deserializedTakerOfferFile.initializationCoinId, equals(initializationCoinId));
    ...
    expect(deserializedTakerOfferFile.acceptedOfferHash, equals(acceptedOfferHash));
  });
  ...
  test('should correctly serialize and deserialize BTC to XCH offer accept file', () {
    ...
    expect(deserializedTakerOfferFile.initializationCoinId, equals(initializationCoinId));
    expect(deserializedTakerOfferFile.validityTime, equals(exchangeValidityTime));
    expect(deserializedTakerOfferFile.publicKey, equals(publicKey));
    expect(deserializedTakerOfferFile.acceptedOfferHash, equals(acceptedOfferHash));
  });
