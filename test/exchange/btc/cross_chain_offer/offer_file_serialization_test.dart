...
void main() {
  ...
  test('should correctly serialize and deserialize XCH to BTC offer file', () {
    ...
    expect(
      deserializedOfferFile.initializationCoinId,
  ...
  test(
    ...
    expect(
      deserializedTakerOfferFile.initializationCoinId,
      equals(initializationCoinId),
    );
    ...
    expect(
      deserializedTakerOfferFile.acceptedOfferHash,
  ...
  test(
    ...
    expect(
      deserializedTakerOfferFile.validityTime,
