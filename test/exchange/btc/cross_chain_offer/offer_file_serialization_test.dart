...
void main() {
  ...
  test('should correctly serialize and deserialize XCH to BTC offer accept file', () {
    ...
    final deserializedOfferTakerFile =
        XchToBtcTakerOfferFile.fromSerializedOfferFile(serializedOfferFile);

    expect(deserializedOfferTakerFile.validityTime, equals(validityTime));
    expect(deserializedOfferTakerFile.publicKey, equals(publicKey));
    expect(
      deserializedOfferTakerFile.lightningPaymentRequest.paymentRequest,
      decodedPaymentRequest.paymentRequest,
    );
    expect(deserializedOfferTakerFile.acceptedOfferHash, equals(acceptedOfferHash));
  });
