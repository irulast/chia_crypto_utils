...
class MockChiaEnthusiast extends ChiaEnthusiastBase {
  ...
  void addStandardCoins() {
    final mockParentCoinInfo = Program.fromInt(1).hash();
    for (var i = 0; i < 5; i++) {
      standardCoins.add(
        Coin(
          confirmedBlockIndex: 17409283 + i,
          spentBlockIndex: 0,
          coinbase: false,
          timestamp: 2748299274 + i,
          parentCoinInfo: mockParentCoinInfo,
          puzzlehash: firstPuzzlehash,
          amount: 1000 + i,
        ),
      );
    }
  ...
  void addCat1Coins() {
    ...
    final catCoin0 = CatCoin.fromParentSpend(
      coin: coin0,
    ...
    final catCoin1 = CatCoin.fromParentSpend(
      coin: coin1,
      parentCoinSpend: parentCoinSpend,
    );
  ...
  void addCatCoins() {
    ...
    final coin0 = Coin(
      ...
      coinbase: false,
      timestamp: 2748299274,
      parentCoinInfo: parentCoinSpend.coin.id,
      puzzlehash: firstPuzzlehash,
      amount: 2000,
    );
    final catCoin0 = CatCoin.fromParentSpend(
