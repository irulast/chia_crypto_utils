...
class TestData {
  ...
  static final validCat1Coin0 = CatCoin.fromParentSpend(
    parentCoinSpend: cat1ParentCoinSpend,
    coin: validCat1BaseCoin0,
  );
  ...
  static final validCatBaseCoin0 = Coin(
    ...
    puzzlehash: WalletKeychain.makeOuterPuzzleHash(
      firstWalletSet.unhardened.puzzlehash,
      catAssetId,
    ),
    amount: 200,
  );
  static final validCatCoin0 = CatCoin.fromParentSpend(
    coin: validCatBaseCoin0,
    parentCoinSpend: catParentCoinSpend,
  );
