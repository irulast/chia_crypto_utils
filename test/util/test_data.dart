...
class TestData {
  ...
  static const chiaFirstAddress = Address(
      'txch1v8vergyvwugwv0tmxwnmeecuxh3tat5jaskkunnn79zjz0muds0qlg2szv');
  static final firstWalletSet =
  ...
  static final chiaCoinRecordFromJson =
      ChiaCoinRecord.fromJson(chiaCoinRecordJson);
  static final coinFromChiaCoinRecordJson =
      Coin.fromChiaCoinRecordJson(chiaCoinRecordJson);
  ...
  static final parentCoinSpend = CoinSpend.fromJson(
  ...
  static final cat1ParentCoinSpend = CoinSpend.fromJson(
      jsonDecode(cat1ParentCoinSpendJson) as Map<String, dynamic>);
  ...
  static final validCat1Coin0 = CatCoin.fromParentSpend(
      parentCoinSpend: cat1ParentCoinSpend, coin: validCat1BaseCoin0);
  static final invalidCatCoin0 = CatCoin.fromParentSpend(
      parentCoinSpend: cat1ParentCoinSpend, coin: validCat1BaseCoin0);
  ...
  static final validCat1Coin1 = CatCoin.fromParentSpend(
      coin: validCat1BaseCoin1, parentCoinSpend: cat1ParentCoinSpend);
  ...
  static final cat1Message = [TestData.validCat1Coin0]
      ...
      .sha256Hash();
  static final cat1AssertCoinAnnouncementCondition =
  ...
  static final cat1NotarizedPayment = NotarizedPayment.fromPayment(
    Payment(1000, validCat1Coin0.puzzlehash,
        memos: const <String>['test', 'test2', 'test3']),
    Puzzlehash.zeros(),
  );
  ...
  static final catParentCoinSpend = CoinSpend.fromJson(
  ...
  static final validCatBaseCoin0 = Coin(
    ...
    puzzlehash: WalletKeychain.makeOuterPuzzleHash(
        firstWalletSet.unhardened.puzzlehash, catAssetId),
    amount: 200,
  );
  static final validCatCoin0 = CatCoin.fromParentSpend(
      coin: validCatBaseCoin0, parentCoinSpend: catParentCoinSpend);
  static final invalidCat1Coin0 = CatCoin.fromParentSpend(
      coin: validCat1BaseCoin0, parentCoinSpend: catParentCoinSpend);
  ...
  static final validCatCoin1 = CatCoin.fromParentSpend(
      coin: validCatBaseCoin1, parentCoinSpend: catParentCoinSpend);
  ...
  static final catNotarizedPayment = NotarizedPayment.fromPayment(
    Payment(1000, validCatCoin0.puzzlehash,
        memos: const <String>['test', 'test2', 'test3']),
    Puzzlehash.zeros(),
  );
}
