...
void main() async {
  ...
  final launcherId = const Address('nft1ysdwllpf63rps75faxnkf7wkpnreyls2x0hqty2emd0f6wk4a34st2ptdj')
      .toPuzzlehash();

  final chunkDid =
      const Address('did:chia:13zkzl0jrn6x79mwgjx7q5eeplfcfl86thf5uws2ssy9w8gypt9kqse8xph')
          .toPuzzlehash();
