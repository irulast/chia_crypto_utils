...
Future<void> main() async {
  ...
  test('should get standard coins by puzzlehashes', () async {
    ...
    for (final testCoin in testStandardCoins) {
      ...
      expect(() => coins.firstWhere((catCoin) => catCoin.puzzlehash == testCoin.puzzlehash),
          returnsNormally,);
    }
  });
  ...
  test('should get cat coins by puzzlehashes', () async {
    final catCoins = await fullNodeSimulator.getCoinsByPuzzleHashes(testCatCoins
        .map(
          (c) => c.puzzlehash,
        )
        .toList(),);
    for (final testCatCoin in catCoins) {
      ...
      expect(() => catCoins.firstWhere((catCoin) => catCoin.amount == testCatCoin.amount),
          returnsNormally,);
      expect(() => catCoins.firstWhere((catCoin) => catCoin.puzzlehash == testCatCoin.puzzlehash),
          returnsNormally,);
    }
  });
}
