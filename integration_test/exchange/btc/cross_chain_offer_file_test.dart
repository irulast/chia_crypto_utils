...
Future<void> main() async {
  ...
  test(
    ...
    // BTC holder's side sends message coin with offer accept file to message puzzlehash
    ...
    // BTC holder's side constructs exchange info from offer file and offer accept file details
    ...
    expect(offerAcceptFileMemo, equals(offerAcceptFile));
