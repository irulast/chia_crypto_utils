...
//     expect(() => CrossChainOfferFileService.checkValidity(deserializedOfferFile), returnsNormally);
...
//     await crossChainOfferFileService.sendMessageCoin(
...
//     final messageVerification = await crossChainOfferFileService.verifyMessageCoinReceipt(
//       messagePuzzlehash,
...
//     final offerAcceptFileMemo = await crossChainOfferFileService
...
//     final offerAcceptFile = crossChainOfferFileService.createXchToBtcTakerOfferFile(
//       serializedMakerOfferFile: serializedOfferFile,
//       validityTime: postAcceptValidityTime,
//       requestorPublicKey: xchHolderPublicKey,
//       paymentRequest: decodedPaymentRequest,
