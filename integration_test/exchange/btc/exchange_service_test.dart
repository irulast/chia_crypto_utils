...
Future<void> main() async {
  ...
  test(
    ...
    // generate disposable mnemonic and private key for user
    ...
    // set clawback period to 24 hours
    const clawbackDelaySeconds = 86400;
  ...
  test('should transfer XCH to chiaswap address and sweep funds to BTC holder using private key',
    ...
    // counter party also has a private key generated for them when they use the service
