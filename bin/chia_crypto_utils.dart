  ...
  Future<void> run() async {
    ...
    if (faucetRequestURL.isNotEmpty && faucetRequestPayload.isNotEmpty) {
      final theFaucetRequestPayload = faucetRequestPayload.replaceAll(
          RegExp('SEND_TO_ADDRESS'), coinAddress.address);
...
class TransferPlotNFTCommand extends Command<Future<void>> {
  ...
  @override
  String get description => 'Transfers ownership of plotNFT.';
  ...
  Future<void> run() async {
    ...
    print('\nNew Owner Public Key: ${newOwnerPublicKey.toHex()}');
    ...
    //   targetPuzzlehash: newOwnerPayoutPuzzlehash,
    //   ownerPublicKey: newOwnerPublicKey,
