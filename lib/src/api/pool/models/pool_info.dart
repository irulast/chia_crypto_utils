...
class PoolInfo {
  ...
  factory PoolInfo.fromJson(Map<String, dynamic> json) {
    return PoolInfo(
      ...
      targetPuzzlehash:
          Puzzlehash.fromHex(json['target_puzzle_hash'] as String),
  ...
  @override
  String toString() =>
      'PoolInfo(name: $name, description: $description, fee: $fee, minimumDifficulty: $minimumDifficulty, protocolVersion: $protocolVersion, relativeLockHeight: $relativeLockHeight, targetPuzzlehash: $targetPuzzlehash, authenticationTokenTimeout: $authenticationTokenTimeout, logoUrl: $logoUrl)';
}
