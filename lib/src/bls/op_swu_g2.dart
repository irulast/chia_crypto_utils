...
var xi_2 = Fq2(q, [Fq(q, -BigInt.two), Fq(q, -BigInt.one)]);
var Ell2p_a = Fq2(q, [Fq(q, BigInt.zero), Fq(q, BigInt.from(240))]);
var Ell2p_b = Fq2(q, [Fq(q, BigInt.from(1012)), Fq(q, BigInt.from(1012))]);
