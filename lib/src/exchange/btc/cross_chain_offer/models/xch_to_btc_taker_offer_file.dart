...
class XchToBtcTakerOfferFile implements TakerCrossChainOfferFile {
  ...
  factory XchToBtcTakerOfferFile.fromSerializedOfferFile(
      String serializedOfferFile) {
    ...
    if (deserializedOfferFile == null) {
      throw InvalidCrossChainOfferType(
          CrossChainOfferFileType.xchToBtcAccept.name);
    }
  ...
  static XchToBtcTakerOfferFile? maybeFromSerializedOfferFile(
      String serializedOfferFile) {
    try {
      final deserializedOfferFile =
          CrossChainOfferFile.fromSerializedOfferFile(serializedOfferFile);
      if (deserializedOfferFile.type !=
          CrossChainOfferFileType.xchToBtcAccept) {
        return null;
      }
  ...
  static Future<XchToBtcTakerOfferFile> fromSerializedOfferFileAsync(
    ...
    final result = await compute(
        XchToBtcTakerOfferFile._fromSerializedOfferFileTask,
        serializedOfferFile);
