...
abstract class TakerCrossChainOfferFile implements CrossChainOfferFile {
  factory TakerCrossChainOfferFile.fromSerializedOfferFile(
  ...
  factory TakerCrossChainOfferFile._fromSerializedOfferFileTask(
    String serializedOfferFile,
  ) {
    return TakerCrossChainOfferFile.fromSerializedOfferFile(
      serializedOfferFile,
    );
  }
  Bytes get acceptedOfferHash;

  static TakerCrossChainOfferFile? maybeFromSerializedOfferFile(
    String serializedOfferFile,
  ) {
    try {
      final deserializedOfferFile =
  ...
  static Future<TakerCrossChainOfferFile> fromSerializedOfferFileAsync(
    ...
    final result = await compute(
      TakerCrossChainOfferFile._fromSerializedOfferFileTask,
      serializedOfferFile,
    );
